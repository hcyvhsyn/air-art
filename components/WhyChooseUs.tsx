    ...
    >
      <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {copy.items.map((item, i) => (
          <li
            key={item.title}
            className="group relative min-h-[210px] overflow-hidden rounded-[1.75rem] border border-white/12 bg-white/[0.07] p-6 shadow-[0_24px_76px_rgba(0,0,0,0.24)] backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-tech/35 hover:bg-white/[0.1]"
          >
            <div
            ...
            <p className="relative mt-4 text-sm leading-relaxed text-white/65">{item.desc}</p>
